  ...
  return (
    <Link
      ...
      className={`group block rounded-xl border transition-all duration-200 hover:shadow-lg ${
        featured
          ? 'p-8 border-primary/40 dark:border-primary-dark/40 bg-gray-400 dark:bg-gray-900 hover:border-primary dark:hover:border-primary-dark ring-1 ring-primary/10 dark:ring-primary-dark/10'
    ...
    >
      ...
      <h3 className={`font-semibold text-white dark:text-white group-hover:text-primary dark:group-hover:text-primary-dark transition-colors ${
