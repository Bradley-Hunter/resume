export const pythonProjectFiles = [
  { name: 'sort_algorithm.py', language: 'python', code: `# Imports the json library.
import json
...
if __name__ == '__main__':
    main()` },
  { name: 'francois.py', language: 'python', code: `# This function will return the number that the user chooses.
def get_num():
    if __debug__:
