...
export default function ProjectPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <Link to="/projects" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors mb-6 inline-flex items-center gap-1">
      ...
      {project.github && (
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-sm font-medium hover:opacity-90 transition-opacity mb-8"
        >
      ...
      {project.files.length > 0 && (() => {
        ...
        if (hasGroups) {
          ...
          return (
            <div>
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Source Code</h2>
