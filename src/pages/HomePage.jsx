    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <Section title="Skills">
        <div className="space-y-3">
          <div>
            <span className="text-sm font-semibold text-gray-900 dark:text-white">Proficient: </span>
            <span className="inline-flex flex-wrap gap-1.5 ml-1">
              {skills.proficient.map((s) => <ToolBadge key={s} name={s} />)}
            </span>
          </div>
          <div>
            <span className="text-sm font-semibold text-gray-900 dark:text-white">Familiar: </span>
            <span className="inline-flex flex-wrap gap-1.5 ml-1">
      ...
      <Section title="Education">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 italic">{education.school}</p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Emphasis: {education.emphasis}</p>
          </div>
      ...
      <div className="text-center mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Want to see my work?</h2>
        <Link
          to="/projects"
